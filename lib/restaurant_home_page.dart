...
class RestaurantHomePage extends StatefulWidget {
  ...
  const RestaurantHomePage({super.key, required this.restaurantName});
...
class _RestaurantHomePageState extends State<RestaurantHomePage>
  ...
  List<Map<String, dynamic>> reservations = [
    {'name': 'João Silva', 'status': 'Pendente', 'people': 4, 'date': '2024-06-30', 'time': '19:00', 'observations': 'Nenhuma'},
    {'name': 'Maria Souza', 'status': 'Confirmado', 'people': 2, 'date': '2024-07-01', 'time': '20:00', 'observations': 'Preferência por mesa perto da janela'},
  ...
  Widget _buildReservationsList({required String status}) {
    List<Map<String, dynamic>> filteredReservations = reservations.where((reservation) => reservation['status'] == status).toList();
          ...
          child: ListTile(
            ...
            trailing: ElevatedButton(
              onPressed: () {
                ...
                _showReservationDetailsDialog(filteredReservations[index], status);
              },
  ...
  void _showReservationDetailsDialog(Map<String, dynamic> reservation, String currentStatus) {
              ...
              content: Column(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    value: newStatus,
                    items: <String>['Pendente', 'Confirmado', 'Encerrado'].map((String value) {
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                    foregroundColor: Colors.white, backgroundColor: const Color(0xFF7D0A0A)),
  ...
  void _updateReservationStatus(Map<String, dynamic> reservation, String newStatus) {
    ...
    // Aqui você pode implementar a lógica para atualizar o status da reserva no banco de dados ou em algum estado global
  }

  void _navigateToTab(String newStatus) {
    int tabIndex = 0;
    switch (newStatus) {
      case 'Pendente':
        tabIndex = 0;
